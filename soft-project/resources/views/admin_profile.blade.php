...
@section('content')
    ...
    <section>
        <div class="profile_holder" style="margin-bottom:10px;border: 1px solid var(--deep-navy);">
            <h4 style="width: 100%;">Profile</h4>
            <div>
                <img src="{{  asset("profile_images/".$admin->profile_pic)
            ...
            <div class="profile_holder" style="width: auto">
                <div class="profile_stats_section">
                    ...
                    <div class="profile_container">
                        Designation: {{ $admin->designationName }}
                    </div>
                    <div class="profile_container">
                    ...
                    <div class="profile_container">
                        ...
                        <div>
                            ...
                            Monthly Salary<br>${{ $admin->salary }}
                        </div>
            </div>
        </div>
            <div class="profile_holder" style="margin-bottom:10px;border: 1px solid var(--deep-navy);">
                ...
                <form id="changeName" action="/admin/updateProfile" method="POST" enctype="multipart/form-data">
                    @csrf
                ...
                <br>
                    ...
                    <input type="text" name="email" class="name_changer" value="{{ $admin->email }}">
                            <br>
